...
activities = {
    ...
    "Basketball Team": {
        "description": "Join our competitive basketball team and compete in friendly matches",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail="Student has already signed up for this activity")
    # Add student
